use crate::{
    DifferenceMergeIterator, DistanceMergeIterator, IntersectionMergeIterator, UnionMergeIterator,
};
use index::Posting;
...
fn test_union_merge_iterator() {
    ...
    let iter = UnionMergeIterator::new(Box::new(left.into_iter()), Box::new(right.into_iter()));
...
fn test_intersection_merge_iterator() {
    ...
    let iter =
        IntersectionMergeIterator::new(Box::new(left.into_iter()), Box::new(right.into_iter()));
...
fn test_difference_merge_iterator() {
    ...
    let iter =
        DifferenceMergeIterator::new(Box::new(left.into_iter()), Box::new(right.into_iter()));
...
fn test_distance_merge_iterator() {
    ...
    let iter =
        DistanceMergeIterator::new(2, Box::new(left.into_iter()), Box::new(right.into_iter()));
...
fn test_distance_merge_iterator_many_docs() {
    ...
    let iter =
        DistanceMergeIterator::new(1, Box::new(left.into_iter()), Box::new(right.into_iter()));
